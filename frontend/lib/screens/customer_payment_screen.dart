      ...
      child: Column(
        ...
        children: [
          ...
          AppDataTable(
            ...
            columns: [
              AppTableColumn(title: 'Receipt #', builder: (p) => Text(p['payment_number'] ?? '', style: const TextStyle(fontWeight: FontWeight.bold))),
              ...
              AppTableColumn(title: 'Payment Amount', builder: (p) => Text(Formatters.formatCurrency(p['amount']), style: const TextStyle(fontWeight: FontWeight.bold, color: AppColors.success))),
              AppTableColumn(title: 'Bill Allocated', builder: (p) => Text(Formatters.formatCurrency(p['allocated_amount']))),
              AppTableColumn(title: 'Advance Credit', builder: (p) => Text(Formatters.formatCurrency(p['advance_credit_amount']), style: TextStyle(color: (p['advance_credit_amount'] ?? 0) > 0 ? AppColors.success : AppColors.textPrimary))),
