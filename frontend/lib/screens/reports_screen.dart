                          ...
                          OutlinedButton.icon(
                            onPressed: () {
                              ...
                              final rows = reportProvider.dailySales.map((b) => [
                                ...
                                b['customer_name'] ?? '',
                                Formatters.formatCurrency(double.tryParse(b['subtotal']?.toString() ?? '0')),
                                Formatters.formatCurrency(double.tryParse(b['cgst_amount']?.toString() ?? '0')),
                                Formatters.formatCurrency(double.tryParse(b['sgst_amount']?.toString() ?? '0')),
                                Formatters.formatCurrency(double.tryParse(b['igst_amount']?.toString() ?? '0')),
                                Formatters.formatCurrency(double.tryParse(b['round_off']?.toString() ?? '0')),
                                Formatters.formatCurrency(double.tryParse(b['grand_total']?.toString() ?? '0')),
                                Formatters.formatCurrency(double.tryParse(b['paid_amount']?.toString() ?? '0')),
                                Formatters.formatCurrency(double.tryParse(b['balance_amount']?.toString() ?? '0')),
                                b['status'] ?? '',
                              ]).toList();
